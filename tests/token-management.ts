...
const LOCKER_MANAGER_PROGRAM_ID = new anchor.web3.PublicKey(
  "81xYZSmJTvL9nYCxH2btBq1ksdTuop791cDjaecJ5RUn"
);
const POOL_MANAGER_PROGRAM_ID = new anchor.web3.PublicKey(
  "6DYsJbtQzaW3WKiWE4Ai9oDcnCPyDZHVRArDeAAWYg5d"
);
const REEARD_KEEPER_PROGRAM_ID = new anchor.web3.PublicKey(
  "DbeXNM8GVHMEeRWePsq4BtsBVtWT3J7aG1SgP4c9zZqJ"
);

describe("Locker Manager and Pool Manager", () => {
  const commitment: Commitment = "confirmed";
  const connection = new Connection("https://summer-silent-ensemble.solana-devnet.discover.quiknode.pro/a98115e9b0f841c6b3311e2bc6b3b59ec4269160/", {
    commitment,
    wsEndpoint: "wss://summer-silent-ensemble.solana-devnet.discover.quiknode.pro/a98115e9b0f841c6b3311e2bc6b3b59ec4269160/",
  });
